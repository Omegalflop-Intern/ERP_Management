...
export default function DocumentVaultModal({ entityType, entityId, entityName, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-3 sm:p-4 overflow-y-auto">
      <div className="bg-white dark:bg-[#111827] w-full max-w-2xl max-w-[calc(100vw-1.5rem)] my-auto rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 overflow-hidden flex flex-col max-h-[90vh]">
        {/* Header */}
