    ...
    <div className="space-y-6 w-full pb-6">
          ...
          <>
            {hasPermission('sales:create') && (
              <button
                ...
                className="px-5 py-2.5 bg-[#9CE700] text-black font-bold rounded-full text-xs transition-all duration-150 shadow-md shadow-[#9CE700]/25 hover:bg-[#8fd500] hover:shadow-lg hover:shadow-[#9CE700]/35 hover:-translate-y-0.5 flex items-center gap-2 active:scale-95"
              >
                <Plus className="w-4 h-4 text-black stroke-[3]" /> New Sale (POS)
              </button>
            )}
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 p-3 bg-white/80 dark:bg-[#121524]/80 backdrop-blur-md rounded-2xl border border-slate-200/80 dark:border-neutral-800">
        <div className="flex items-center gap-2">
          ...
          <span className="px-2 py-0.5 rounded-md bg-[#9CE700]/10 text-[#7dbb00] dark:text-[#9CE700] font-mono font-bold text-xs border border-[#9CE700]/20">
            {currentPeriodLabel}
          </span>
        </div>

        <div className="flex items-center gap-1.5 p-1 bg-slate-100 dark:bg-[#141414] rounded-xl border border-slate-200/60 dark:border-neutral-800/80 self-stretch sm:self-auto overflow-x-auto">
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all duration-150 whitespace-nowrap ${
                  active
                    ? 'bg-[#9CE700] text-black shadow-xs font-bold'
                    : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-white/50 dark:hover:bg-neutral-800/60'
                }`}
              >
                {opt.label}
              </button>
          ...
          <div className="glass-secondary rounded-[20px] p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="text-xs font-semibold text-[#7dbb00] dark:text-[#9CE700] hover:underline flex items-center gap-1"
              >
