          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/40 border border-slate-200/60 dark:border-slate-700/60">
              ...
              <div className="text-sm font-bold text-slate-900 dark:text-white">
                NID Number:{' '}
                <span className="font-mono text-[#2563EB]">{kyc.nidNumber || 'Not provided'}</span>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="border border-slate-200 dark:border-slate-800 rounded-xl p-3 bg-slate-50/50 dark:bg-slate-900/30">
                ...
                {kyc.nidFront ? (
                  <img
                    src={getAssetUrl(kyc.nidFront)}
                    alt="NID Front"
                    className="w-full h-36 object-cover rounded-lg border border-slate-200 dark:border-slate-800"
                  />
                ) : (
                  <div className="w-full h-36 bg-slate-100 dark:bg-slate-800 rounded-lg flex items-center justify-center text-xs text-slate-400">
                    Not Uploaded
                  </div>
                )}
              </div>
              ...
              <div className="border border-slate-200 dark:border-slate-800 rounded-xl p-3 bg-slate-50/50 dark:bg-slate-900/30">
                <div className="text-xs font-semibold text-slate-700 dark:text-slate-300 mb-2 flex items-center justify-between">
                  ...
                  {kyc.tradeLicenseFile && (
                    <a
                      href={getAssetUrl(kyc.tradeLicenseFile)}
                      target="_blank"
                      rel="noreferrer"
                      className="text-[#2563EB] hover:underline text-xs flex items-center gap-1"
                    >
                ...
                {kyc.tradeLicenseFile ? (
                  <div className="w-full h-36 bg-blue-50/50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-900 flex flex-col items-center justify-center p-3 text-center">
                    ...
                    <span className="text-xs font-semibold text-slate-700 dark:text-slate-300 truncate w-full">
                      Trade License File
                    </span>
                  </div>
                ) : (
              ...
              <div className="border border-slate-200 dark:border-slate-800 rounded-xl p-3 bg-slate-50/50 dark:bg-slate-900/30">
                <div className="text-xs font-semibold text-slate-700 dark:text-slate-300 mb-2 flex items-center justify-between">
                  ...
                  {kyc.tinCertificate && (
                    <a
                      href={getAssetUrl(kyc.tinCertificate)}
                      target="_blank"
                      rel="noreferrer"
                      className="text-[#2563EB] hover:underline text-xs flex items-center gap-1"
                    >
