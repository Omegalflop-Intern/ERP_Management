...
export default function StockOverview() {
  ...
  const handleAddCategory = async (e) => {
    ...
    try {
      setCreatingCat(true);
      await api.post('/catalog', { name: newCatName.trim(), type: 'CATEGORY' });
    ...
    <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="px-2.5 py-1.5 text-xs font-bold bg-[#2563EB] hover:bg-blue-600 text-white rounded-xl flex items-center gap-1 transition-all shadow-sm flex-shrink-0"
            >
      ...
      {showAddCategoryModal && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#111827] rounded-2xl w-full max-w-sm border border-slate-200 dark:border-slate-800 shadow-2xl p-6 space-y-4">
            <h3 className="font-bold text-base text-slate-900 dark:text-white flex items-center gap-2">
              <Tag className="w-4 h-4 text-blue-500" /> Create New Category
            </h3>
            <form onSubmit={handleAddCategory} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Smartwatches / Accessories"
                  className="w-full px-3 py-2 text-sm bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 text-slate-900 dark:text-white"
                />
              </div>
              <div className="flex justify-end gap-2 pt-2">
                ...
                <button
                  ...
                  className="px-4 py-2 text-xs font-bold bg-[#2563EB] hover:bg-blue-600 text-white rounded-xl disabled:opacity-50 transition-all shadow-md"
                >
