...
export default function ForgotPassword() {
  ...
  const inputClass = styled
    ? 'neu-input w-full px-4 py-3 pl-10 text-sm focus:outline-none transition-all'
    : 'w-full px-4 py-3 pl-10 rounded-xl text-sm focus:outline-none transition-all duration-300 bg-white dark:bg-gray-900/80 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:border-red-500 focus:ring-2 focus:ring-red-500/20';
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-50 dark:bg-[#0b0f19]">
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="text-center mt-5">
          <Link to="/login" className="inline-flex items-center gap-1.5 text-sm text-gray-500 hover:text-red-500 dark:text-gray-400 dark:hover:text-red-400 transition-colors font-medium">
