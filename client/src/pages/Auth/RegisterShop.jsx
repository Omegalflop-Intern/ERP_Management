...
export default function RegisterShop() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl bg-slate-800/80 border border-slate-700/60 rounded-2xl shadow-2xl p-6 sm:p-8 space-y-6 backdrop-blur-xl">
        
        {/* Header */}
        <div className="text-center space-y-2">
          <div className="w-12 h-12 rounded-2xl bg-[#2563EB]/20 border border-blue-500/30 flex items-center justify-center mx-auto text-[#2563EB]">
        ...
        {/* Step Indicator */}
        <div className="flex items-center justify-between border-b border-slate-700/60 pb-4 text-xs font-semibold text-slate-400">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-2.5 rounded-xl border border-slate-700 bg-slate-900 text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="flex-1 text-xs text-slate-400 file:mr-2 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:bg-blue-600 file:text-white file:font-semibold file:text-xs"
                  />
                  {files.logo && (
                    <img
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs text-slate-400 file:mr-2 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:bg-blue-600 file:text-white"
                  />
                </div>
                <div>
              ...
              <div className="pt-4 flex justify-between">
                <button
                  type="button"
                  onClick={() => setStep(1)}
                  className="px-4 py-2.5 bg-slate-700 text-white font-semibold rounded-xl flex items-center gap-1.5"
                >
            ...
            <div className="space-y-3">
              ...
              <div className="pt-4 flex justify-between">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-[#2563EB] hover:bg-blue-700 text-white font-semibold rounded-xl flex items-center gap-1.5 disabled:opacity-50"
                >
