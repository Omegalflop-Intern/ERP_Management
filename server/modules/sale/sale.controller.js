...
export const processReturn = async (req, res, next) => {
  try {
    const tenantId = req.user?.tenantId || null;
    const result = await saleService.processReturn(req.params.id, req.body, tenantId);
...
export const updateSale = async (req, res, next) => {
  try {
    const tenantId = req.user?.tenantId || null;
    const sale = await saleService.updateSale(req.params.id, req.body, tenantId, req.user?.username || 'system');
