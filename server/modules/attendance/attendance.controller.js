...
export const checkIn = async (req, res, next) => {
  try {
    ...
    const attendance = await attendanceService.checkIn(employeeId, location, notes);
...
export const getAttendanceReport = async (req, res, next) => {
  try {
    ...
    const result = await attendanceService.getAttendanceReport(Number(page), Number(limit), employeeId, branch, from, to);
